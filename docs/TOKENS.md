...
```bash
bkg-peer wallet balance            # Show available / in-escrow / total
bkg-peer wallet history            # Recent transactions
bkg-peer serve --share-inference   # Earn tokens by serving LLM requests
```
