        ...
        <TabsContent value="library" className="mt-6 space-y-6 focus-visible:outline-none">
          <Card>
            <CardHeader>
              ...
              <CardDescription>CLI: bkg-peer skill scan</CardDescription>
            </CardHeader>
                ...
                <>
                  ...
                  {!meta.registry_attached && (
                    <p className="text-xs text-amber-400">
                      Registry not attached -- use full `bkg-peer serve --web`.
                    </p>
                  )}
        ...
        <TabsContent value="templates" className="mt-6 space-y-6 focus-visible:outline-none">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Pre-built SKILL.md files that ship with bkg-peer. Install them into your skills directory to activate.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
              {templates.length === 0 ? (
