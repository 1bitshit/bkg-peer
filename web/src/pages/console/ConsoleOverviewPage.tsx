      ...
      <div className="rounded-xl border border-border bg-card/50 p-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <Badge variant={online ? "default" : "secondary"} className="font-normal">
            {online ? "Node online" : "Offline — run: bkg-peer serve --web 127.0.0.1:8080"}
          </Badge>
          {online && st && (
              ...
              <Card>
                <CardContent className="py-10 text-center text-sm text-muted-foreground">
                  ...
                  <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-[11px] text-primary">
                    bkg-peer serve --web 127.0.0.1:8080 --agent templates/agents/coder.toml
                  </code>
                </CardContent>
              </Card>
            ) : (
