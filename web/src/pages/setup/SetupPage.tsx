...
const LS_SETUP_DONE = "bkg-peer_setup_done"
      ...
      <div className="w-full max-w-xl space-y-6">
        ...
        {step === "welcome" && (
          <div className="space-y-5 text-center">
            ...
            <div>
              <h1 className="text-2xl font-bold">Welcome to bkg-peer</h1>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Choose how bkg-peer runs inference. Enable one or more backends.
              </p>
            </div>
        ...
        {step === "done" && (
          <div className="space-y-5 text-center">
            ...
            <div>
              ...
              <p className="mt-1.5 text-sm text-muted-foreground">
                bkg-peer is configured. Change settings anytime from the sidebar.
              </p>
            </div>
            ...
            <Button size="lg" className="w-full gap-2" onClick={finish}>
              Open bkg-peer <ChevronRight className="size-4" />
            </Button>
