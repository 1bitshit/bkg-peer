...
const CHAT_SESSION_KEY = "bkg-peer_chat_session_v1"
const TRANSCRIPT_KEY_PREFIX = "bkg-peer_chat_transcript_v1_"
          ...
          <div className="relative min-h-0 flex-1">
            ...
            <div className="flex min-h-0 flex-1 flex-col justify-center py-8">
              <div className="mx-auto max-w-lg text-center">
                <h1 className="text-2xl font-semibold tracking-tight md:text-3xl">bkg-peer</h1>
